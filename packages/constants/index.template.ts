...
export const UNISWAP_ENERGYFI_ETH_PAIR_FIRST_LIQUDITY_BLOCK = BigInt.fromI32(10750005)

export const ACC_ENERGYFI_PRECISION = BigInt.fromString('1000000000000')
...
export const MASTER_CHEF_V2_ADDRESS = Address.fromString('0xB3847E47E7c0db94e05E504cb64e300709df0297')

export const ENERGYFI_BAR_ADDRESS = Address.fromString(
  '{{ energyFi_bar_address }}{{^energyFi_bar_address}}0x0000000000000000000000000000000000000000{{/energyFi_bar_address}}'
)

export const ENERGYFI_MAKER_ADDRESS = Address.fromString(
  '{{ energyFi_maker_address }}{{^energyFi_maker_address}}0x0000000000000000000000000000000000000000{{/energyFi_maker_address}}'
)

export const ENERGYFI_TOKEN_ADDRESS = Address.fromString(
  '{{ energyFi_address }}{{^energyFi_address}}0x0000000000000000000000000000000000000000{{/energyFi_address}}'
)

export const ENERGYFI_USDT_PAIR_ADDRESS = Address.fromString(
  '{{ energyFi_usdt_pair_address }}{{^energyFi_usdt_pair_address}}0x0000000000000000000000000000000000000000{{/energyFi_usdt_pair_address}}'
)

export const XENERGYFI_USDC_PAIR_ADDRESS = Address.fromString(
  '{{ xenergyFi_usdc_pair_address }}{{^xenergyFi_usdc_pair_address}}0x0000000000000000000000000000000000000000{{/xenergyFi_usdc_pair_address}}'
)

export const XENERGYFI_WETH_PAIR_ADDRESS = Address.fromString(
  '{{ xenergyFi_weth_pair_address }}{{^xenergyFi_weth_pair_address}}0x0000000000000000000000000000000000000000{{/xenergyFi_weth_pair_address}}'
)

export const ENERGYFI_DISTRIBUTOR_ADDRESS = Address.fromString(
  '{{ energyFi_distributor_address }}{{^energyFi_distributor_address}}0x0000000000000000000000000000000000000000{{/energyFi_distributor_address}}'
)
...
export const ENERGYFI_USDT_PAIR =
  '{{ energyFi_usdt_pair }}{{^energyFi_usdt_pair}}0x0000000000000000000000000000000000000000{{/energyFi_usdt_pair}}'
...
export const ENERGYFISWAP_WETH_USDT_PAIR_ADDRESS = Address.fromString(
  '{{ energyFiswap_weth_usdt_pair_address }}{{^energyFiswap_weth_usdt_pair_address}}0x0000000000000000000000000000000000000000{{/energyFiswap_weth_usdt_pair_address}}'
)
...
export const UNISWAP_ENERGYFI_ETH_PAIR_ADDRESS = Address.fromString(
  '{{ uniswap_energyFi_eth_pair_address }}{{^uniswap_energyFi_eth_pair_address}}0x0000000000000000000000000000000000000000{{/uniswap_energyFi_eth_pair_address}}'
)

export const UNISWAP_ENERGYFI_USDT_PAIR_ADDRESS = Address.fromString(
  '{{ uniswap_energyFi_usdt_pair_address }}{{^uniswap_energyFi_usdt_pair_address}}0x0000000000000000000000000000000000000000{{/uniswap_energyFi_usdt_pair_address}}'
)
